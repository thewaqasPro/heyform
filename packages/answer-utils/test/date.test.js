...
;(0, vitest_1.test)('valid dates', () => {
  validDates.forEach(([date, format]) => {
    ;(0, vitest_1.expect)((0, helper_1.isDate)(date, format)).toBe(true)
  })
})
;(0, vitest_1.test)('invalid date', () => {
  invalidDates.forEach(([date, format]) => {
    ;(0, vitest_1.expect)((0, helper_1.isDate)(date, format)).toBe(false)
  })
})
